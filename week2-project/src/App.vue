    ...
    <main class="p-5">
      ...
      <section> 
        <div class="italic cursor-pointer text-purple-600 hover:text-cyan-500">
          <p v-on:click="addMode = true">Add New Group asdjasod</p>
        </div>
      </section>
      <section>
        <button @click="musicControl" st> <h1>play music </h1> </button>
      </section>
      ...
      <section v-show="addMode === false">
        ...
        <div v-for="(group, index) in filteredGroupWorks" :key="group.ID" class="grid grid-cols-12 gap-2"
        ...
        <div class="flex justify-center gap-2">
          <p @click="getRows(n)" :class="currentPage === n ? 'bg-white text-black' : ''"
            v-for="(n, index) in getLastPage(groups, 10)" :key="index"
